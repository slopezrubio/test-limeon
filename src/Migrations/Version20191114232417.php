...
final class Version20191028120536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE actions (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, apartment_id INT NOT NULL, room_id INT NOT NULL, description LONGTEXT DEFAULT NULL, date_of_work DATE NOT NULL, responsable VARCHAR(255) NOT NULL, email_responsable VARCHAR(255) NOT NULL, phone_number_responsable LONGTEXT NOT NULL, attached_files LONGTEXT DEFAULT NULL, created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP NOT NULL DEFAULT NOW() ON UPDATE NOW(), INDEX IDX_47CC8C9254177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE actions ADD CONSTRAINT FK_729F519B176DFE14 FOREIGN KEY (apartment_id) REFERENCES apartments (id)');
        $this->addSql('ALTER TABLE actions ADD CONSTRAINT FK_4D7E68544D2A7E13 FOREIGN KEY (building_id) REFERENCES buildings (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE actions DROP FOREIGN KEY FK_4D7E68544D2A7E13');
        $this->addSql('ALTER TABLE actions DROP FOREIGN KEY FK_729F519B176DFE14');
